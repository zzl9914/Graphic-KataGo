...
cd /d "%~dp0..\scr"
"%PY%" gkt_train_cpu.py --net 1dcnn --hidden 512 --kernel-size 3 --conv-layers 20 --graphs 0 --rounds 20 --freeze-policy-until-round 10 --value-weight 30 --own-weight 5 --q-lambda 0.5 --lr 1e-4 --temperature 0.1 --sim 256 --workers 1 --gpw 32 --steps 16 --no-arena --buffer-drop-from-round 21 --model-snapshot-rounds 25 --outdir ../base/cultivate2/cnn1d --resume !RESUME!
