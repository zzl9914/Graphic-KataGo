...
cd /d "%~dp0..\scr"
"%PY%" gkt_train_gpu.py --net 2dcnn --graphs 0 --rounds 20 --freeze-policy-until-round 10 --no-arena --buffer-drop-from-round 21 --model-snapshot-rounds 25 --outdir ../base/cultivate2/cnn2d --resume !RESUME!
